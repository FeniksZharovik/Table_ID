    ...
    <section class="section">
        <div class="container mt-5">
            <div class="section-header d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-secondary" onclick="window.location.href='siswa.php'">Tampilkan Data Siswa</button>
            </div>
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            ...
                                            <a href="profile.php?id=<?= $data['id_kelas'] ?>" class="btn btn-info btn-sm">Profil</a>
                                        </td>
                                    </tr>
                                <?php
                                }
